...
namespace Bot_sv
{
    ...
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            string token = "6219038817:AAFYWHjmuf5ZlRayggIwzZTE8PJtLHXeP9o";
            ...
            async Task HandleUpdateAsync(ITelegramBotClient botClient, Update update, CancellationToken cancellationToken)
            {
                ...
                {
                    reply = "Nói liên tục đê?";
                }
                else if (messLow.StartsWith("bình"))
                {
                    reply = "Là thằng sửa cái đoạn code này ";
                }
                ...
                if (messLow.Contains("hoadon1"))
                {
                    reply = "mahoadon:1" +
                        ...
                        "tiennuoc=30000" +
                        "tienmang=300000" +
                        "trên đây là hóa đơn 1 ";
                }
                else if (messLow.StartsWith("Đúng vậy"))
                {
                    reply = "Cũng ô kê đấy nhỉ";
                }
                else if (messLow.StartsWith("Bây giờ là năm bao nhiêu "))
                {
                    reply = "mày vừa chơi đá à ";
                }
                ...
                {
                    reply = "🤡bạn hỏi nhiều thế tôi không biết " + messageText +" nghĩa là gì";
                }
        ...
        private void InitializeComponent()
        {
            ...
            // txtLog
            // 
            this.txtLog.Location = new System.Drawing.Point(227, 140);
            this.txtLog.Multiline = true;
            this.txtLog.Name = "txtLog";
            this.txtLog.Size = new System.Drawing.Size(461, 235);
            ...
            this.label1.Text = "Bot này hơi dốt xíu";
            // 
            // Form1
            // 
